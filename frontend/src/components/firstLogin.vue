        ...
        <div class="row">
            <div class="w-80 col-12">
                ...
                <div class="row mx-1">
                    ...
                    <div class="col col-sm-12 col-md-6 col-lg-6 mt-5">
                        ...
                        <form name="form" @submit.prevent="firstLogin">
                            ...
                            <div class="form-group">
                                ...
                                />
                                <div v-if="$v.form.token.$error">
                                    <div v-if="!$v.form.token.required" class="error-message">
                                        <small>The token field is required</small>
                                    </div>
                                </div>
                                <div class="text-muted">
                                    <small class="pl-2">Please enter the verification token sent on your email when you signed up </small>
                                </div> 
                            </div>
                    ...
                    <!---svg code-->
                    <div class="col col-sm-12 col-md-5 col-lg-5 mt-5 pt-4">
                        <img
